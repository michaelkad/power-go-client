...
// NewPcloudSharedprocessorpoolsPutParams creates a new PcloudSharedprocessorpoolsPutParams object,
...
func NewPcloudSharedprocessorpoolsPutParams() *PcloudSharedprocessorpoolsPutParams {
	return &PcloudSharedprocessorpoolsPutParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewPcloudSharedprocessorpoolsPutParamsWithTimeout creates a new PcloudSharedprocessorpoolsPutParams object
...
// NewPcloudSharedprocessorpoolsPutParamsWithContext creates a new PcloudSharedprocessorpoolsPutParams object
...
// NewPcloudSharedprocessorpoolsPutParamsWithHTTPClient creates a new PcloudSharedprocessorpoolsPutParams object
...
func (o *PcloudSharedprocessorpoolsPutParams) WithDefaults() *PcloudSharedprocessorpoolsPutParams {
	o.SetDefaults()
	return o
}
...
func (o *PcloudSharedprocessorpoolsPutParams) WithTimeout(timeout time.Duration) *PcloudSharedprocessorpoolsPutParams {
...
func (o *PcloudSharedprocessorpoolsPutParams) WithContext(ctx context.Context) *PcloudSharedprocessorpoolsPutParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the pcloud sharedprocessorpools put params
func (o *PcloudSharedprocessorpoolsPutParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the pcloud sharedprocessorpools put params
func (o *PcloudSharedprocessorpoolsPutParams) WithHTTPClient(client *http.Client) *PcloudSharedprocessorpoolsPutParams {
...
func (o *PcloudSharedprocessorpoolsPutParams) WithBody(body *models.SharedProcessorPoolUpdate) *PcloudSharedprocessorpoolsPutParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the pcloud sharedprocessorpools put params
func (o *PcloudSharedprocessorpoolsPutParams) SetBody(body *models.SharedProcessorPoolUpdate) {
	o.Body = body
}
...
func (o *PcloudSharedprocessorpoolsPutParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
